...
print("Step 9")
print(my_array.index(12))  # return index of given element
...
# 13. Convert array to string using tobytes() method and back using frombytes()
...
strTemp = my_array.tobytes()
print(strTemp)
my_array2 = array("i", [34,55,66])
print(my_array2)
my_array2.frombytes(strTemp)
print(my_array2)
